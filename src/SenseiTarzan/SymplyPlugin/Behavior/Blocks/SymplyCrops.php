...
use SenseiTarzan\SymplyPlugin\Behavior\Blocks\Utils\SymplyStaticSupportTrait;
...
class SymplyCrops extends Flowable implements Ageable, IPermutationBlock
{
	use AgeableTrait;
	use SymplyStaticSupportTrait;
