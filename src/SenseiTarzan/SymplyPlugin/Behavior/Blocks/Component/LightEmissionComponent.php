...
final class LightEmissionComponent extends AbstractComponent
{
	public function __construct(private readonly int $emission)
	{
	}
	...
	{
		return CompoundTag::create()->setByte("emission", $this->emission);
	}
}
