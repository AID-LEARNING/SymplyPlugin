...
final class ItemBuilder
{
	 ...
	 * @param ItemCreativeInfo $creativeInfo
	 * @return $this
	 */
	...
	/**
	 * ??
	 * @param TextureTypeEnum $textureType
	 * @return $this
	 */
	 ...
	 * @param array|null $mainHand
	 * @param array|null $offHand
