...
class AsyncOverwritePMMPTask extends AsyncTask
{
	...
	public function onRun() : void
	{
		foreach ($this->blockFuncs as [$blockClosure, $serialize, $deserialize]) {
			SymplyBlockFactory::getInstance(true)->overwriteBlockPMMP($blockClosure, $serialize, $deserialize);
		}

		foreach ($this->itemFuncs as [$itemClosure, $serialize, $deserialize]){
			SymplyItemFactory::getInstance(true)->overwriteItemPMMP($itemClosure, $serialize, $deserialize);
		}
	}
}